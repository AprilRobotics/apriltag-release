## apriltag (foxy) - 3.2.0-1

The packages in the `apriltag` repository were released into the `foxy` distro by running `/usr/bin/bloom-release apriltag -r foxy` on `Thu, 10 Mar 2022 16:02:13 -0000`
...
## apriltag (noetic) - 3.1.6-1

The packages in the `apriltag` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic apriltag` on `Fri, 17 Sep 2021 12:48:48 -0000`
...
## apriltag (melodic) - 3.1.6-1

The packages in the `apriltag` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic apriltag` on `Thu, 19 Aug 2021 11:28:50 -0000`
...
## apriltag (melodic) - 3.1.5-1

The packages in the `apriltag` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic apriltag --edit` on `Tue, 17 Aug 2021 19:11:00 -0000`
...
## apriltag (foxy) - 3.1.5-1

The packages in the `apriltag` repository were released into the `foxy` distro by running `/usr/bin/bloom-release -r foxy apriltag --edit` on `Tue, 17 Aug 2021 18:51:47 -0000`
...
## apriltag (noetic) - 3.1.5-1

The packages in the `apriltag` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic apriltag --edit` on `Tue, 17 Aug 2021 18:45:43 -0000`
